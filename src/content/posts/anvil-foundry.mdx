---
title: 'Anvil Foundry Guide: High-Performance Local Ethereum Node for Testing'
description: 'Learn how to deploy and manage a local Ethereum EVM node using Anvil Foundry for lightning-fast smart contract testing.'
date: '2026-02-07T09:00:00Z'
updated: '2026-02-13T18:00:00Z'
author: 'Javier Rodriguez'
tags: ['foundry', 'anvil', 'smart-contracts', 'ethereum', 'web3', 'evm']
category: 'tooling'
published: true
---
<br />
<i>
**TL;DR**: Anvil is a local Ethereum node (EVM) designed for development and testing. It allows you to run a local blockchain with 10 pre-funded accounts (10,000 ETH each),
